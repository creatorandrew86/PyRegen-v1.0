...
def create_seg(root, tab3, seg_number, stepped_button):
    ...
    seg_window.geometry(f'350x335+{window_width}+300')
    ...
    tInput.grid(column=1, row=7, padx=5, pady=0, sticky='W')
    ...
    def reset():
        ...
        stepped_button.config(state='normal')
